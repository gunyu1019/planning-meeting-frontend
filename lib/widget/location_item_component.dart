...
class LocationItemComponent extends ConsumerStatefulWidget {
  ...
  LocationItemComponent({
    ...
    this.onRemoveButtonEvent,
  });

  @override
  ConsumerState<LocationItemComponent> createState() =>
      LocationItemComponentState();
}
...
class LocationItemComponentState extends ConsumerState<LocationItemComponent> {
                ...
                onTap: () {
                  setState(() {
                    ...
                    ref
                        ...
                        .state
                        .onModifyPoi(widget.location.id, category);
                  });
  ...
  Widget title() => isEditing
      ...
      : GestureDetector(
          ...
          onTap: () {
            final newCameraPosition = CameraUpdate.newCenterPosition(
              widget.location.position,
            );
            final cameraAnimation = CameraAnimation(1000);
            ref
                .read(kakaoMapControllerProvider.notifier)
                .state
                ?.moveCamera(newCameraPosition, animation: cameraAnimation);
          },
          child: Text(
            ...
            IconButton(
              ...
              onPressed: () {
                ref
                    .read(mapControllerProvider.notifier)
                    .state
                    .onRemovePoi(widget.location.id);
